...
const socialLinks = [
  {
    name: "GitHub",
    url: "https://github.com/momenalhamza",
    icon: (
  ...
  {
    name: "LinkedIn",
    url: "https://www.linkedin.com/in/momen-alhamza-7b04102b5?utm_source=share_via&utm_content=profile&utm_medium=member_android",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 py-16">
          <div className="space-y-6">
            ...
            <p className="text-gray-300 max-w-sm">
              Artificial Intelligence and Data Science graduate passionate about
              building practical machine learning, deep learning, and computer
              vision solutions.
            </p>
        ...
        <div className="border-t border-gray-800 py-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-gray-300 text-sm">
              © {new Date().getFullYear()} Momen Hamza. All rights reserved.
            </p>
          </div>
        </div>
      </div>
